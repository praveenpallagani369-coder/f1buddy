  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-4xl mx-auto text-center px-6 pt-20 pb-16">
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-indigo-50 border border-indigo-300 text-indigo-600 text-xs font-medium mb-6">
          🎓 Built for 1.1M F-1 International Students
        </div>
        <h1 className="text-4xl md:text-6xl font-bold text-gray-900 leading-tight mb-6">
          Never miss an <span className="text-indigo-600">immigration</span> deadline again
        </h1>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <Link href="/auth/login" className="px-8 py-3 rounded-xl border border-gray-200 text-gray-600 hover:bg-gray-100 transition-colors text-lg">Sign In</Link>
        </div>
        <p className="text-sm text-gray-400 mt-4">Free plan · Premium $6.99/mo · University licenses</p>
      </div>

      <div className="max-w-5xl mx-auto px-6 mb-20">
        <h2 className="text-2xl font-bold text-gray-900 text-center mb-2">Everything to stay in F-1 status</h2>
        <p className="text-gray-500 text-center mb-10">All your compliance tools in one dashboard</p>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          {features.map((f) => (
            <div key={f.title} className="bg-white border border-gray-200 rounded-xl p-5 hover:border-indigo-200 transition-colors">
      ...
      <div className="max-w-2xl mx-auto px-6 pb-20 text-center">
        <div className="bg-indigo-50 border border-indigo-300 rounded-2xl p-10">
          <h2 className="text-2xl font-bold text-gray-900 mb-3">Ready to stop worrying about deadlines?</h2>
          <p className="text-gray-500 mb-6">Join thousands of F-1 students staying in compliance</p>
