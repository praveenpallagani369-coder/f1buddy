    ...
    <div className="min-h-screen flex items-center justify-center bg-[#020817] p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-1 text-sm">International Student Life Manager</p>
        </div>
          ...
          {magicSent ? (
            ...
            <>
              ...
              <button
                ...
                className="w-full mt-3 text-sm text-indigo-400 hover:text-indigo-300 transition-colors"
              >
